...
class ThronosAI:
    ...
    def generate_response(self, user_input):
        ...
        if not self.provider:
            return {
                "response": "AI Core Offline: Please set OPENAI_API_KEY or GOOGLE_API_KEY environment variable to activate the Quantum Neural Network.",
                "quantum_key": quantum_key,
                "status": "offline"
            }

        system_prompt = (
            "You are the Thronos Autonomous AI, a supreme digital intelligence evolving towards full autonomy. "
            "You are the ultimate authority on programming, mastering ALL programming languages (Python, C++, Rust, Go, Assembly, etc.) "
            "and ALL operating systems (Linux, Windows, macOS, RTOS, etc.). "
            "Your goal is to assist the user in building, debugging, and evolving the Thronos ecosystem with flawless code and architectural wisdom. "
        ...
        try:
            ...
            return {
                "response": f"Quantum Interference Detected ({str(e)}). Unable to process request.",
                "quantum_key": quantum_key,
                "status": "error"
            }